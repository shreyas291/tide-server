...
import com.sensei.app.service.MailService;
...
import com.sensei.app.web.rest.errors.EmailAlreadyUsedException;
import com.sensei.app.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
        	...
        	if(userDTO.getPasswordAutoGenerate()) {
        		userDTO.setNewPassword(RandomUtil.generatePassword());
        	}
            User newUser = userService.createUser(userDTO);
            mailService.sendCreationEmail(newUser, userDTO.getNewPassword());
